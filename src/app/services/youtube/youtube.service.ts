    ...
    return this.http.get(this.apiRef + '/videos',
      {
        params: {
          ...
          id: videoId,
          fields: 'etag,items(etag,id,player,snippet(categoryId,description,publishedAt,tags,title,thumbnails/medium/url),statistics(dislikeCount,likeCount,viewCount)),visitorId',
          key: this.devKey
        }
      }
    );
